...
/*   Updated: 2025/01/07 19:38:06 by mbaypara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_scene	*temp_scene(t_scene *scene)
{
	...
	camera->orientation = (t_vector3){0, 0, 0};
	camera->fov = 90;

	light->position = (t_vector3){-25, 20, 20};
	light->ratio = 0.9 * 255;
	light->color = *mult_color_d((t_color){255, 255, 255}, light->ratio);

	sphere->pos = (t_vector3){-5, 0, -15};
	sphere->radius = 5 * 5;
	...
	cylinder->dir = vec3_norm((t_vector3){-9, 0, 0});
	cylinder->radius = 4 / 2;
	...
	cylinder->color = (t_color){0, 0, 255};

	plane->pos = (t_vector3){0, -5, 0};
	plane->normal = vec3_norm((t_vector3){0, 1, 0.1});
	plane->color = (t_color){255, 155, 100};
